...
class aloitusruutu:
    ...
    def __init__(self, ikkuna=Tk):
        ...
        ttk.Label(self.ruutu, text="Kohinanpoistotyökalu").grid(column=1, row=1, sticky=N)
        ttk.Label(
            self.ruutu,
            text="Ruudun yläreunasta löytyy valikko, josta voit navigoida eri sivuille."
            ).grid(column=1, row=3, sticky=N)
        ohjeLinkki = ttk.Label(self.ruutu, text="Ohjeita työkalun käyttöön", foreground="blue", cursor="hand2")
    ...
    def kayttoOhje(self):
        webbrowser.open_new("https://github.com/VehvilainenPooki/AlgoritmitJaTekoaly/blob/main/Dokumentaatio/Käyttöohje.md")
