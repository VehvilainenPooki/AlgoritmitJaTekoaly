...
class Taajuudenpoisto:
    def __init__(self, ikkuna=Tk):
        ...
        ttk.Button(self.ruutu, text="Hae data", command=lambda: self._hae_data()).grid(
        ...
        ttk.Label(self.ruutu, text="Valitse poistettava kohta:").grid(
        ...
        ttk.Label(self.ruutu, text="Valitse poiston leveys:").grid(
        ...
        ttk.Button(
            self.ruutu, text="Päivitä näkymä", command=lambda: self._paivita_kuvaaja()
    ...
    def _paivita_kuvaaja(self):
        if self.nykyinenData is not None:
            ...
            self.taulu.axvspan(
                xmin=relatiivinenLeveysMin, xmax=relatiivinenLeveysMax, **{"alpha": 0.5}
            )
            self.kuvaajaTk.draw()
